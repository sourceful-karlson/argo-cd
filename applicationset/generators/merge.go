...
var (
	...
	ErrNonUniqueParamSets           = fmt.Errorf("the arguments from a generator were not unique by the given mergeKeys, Merge requires all param sets to be unique")
)
...
// getParams get the arguments generated by this generator.
